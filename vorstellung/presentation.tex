...
\title[]{Projekt 1a: Zwischenbericht} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\begin{frame}
  ...
  \begin{itemize}
  	\item \emph{Grundgerüst Software}
  	\item \emph{Sensoren - Abfragen}
  	\item \emph{Sensoren - Einlesen}
  	\item \emph{Sensoren - Zusammenführen}
  	\item \emph{Sleep Modus}
  	\item \emph{Steuerung Solarzelle}
...
\begin{frame}
  ...
  \begin{itemize}
  	\item \emph{Speichern der Messdaten auf SD-Karte}
  	\item \emph{Kommunikation mittels Bluetooth}
  	\item \emph{Testen der Software (nach Zusammenbau)}
  	\item \emph{Test- bzw. Vorführmodus}
   \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
  	...
  	\item \emph{Dokumentation blablabla} %wird Montag eingereicht
  \end{itemize}
\end{frame}
